...
export const DishName = ({dishName, setDishName}) => {
    const history = useHistory();
    return (
        <>
            <div className="create-recipe-wrapper step1" >
                <div className="item0">
                    <BackCreateBtn/>
                </div>
            ...
            {dishName !== "" && <CustomButton className="mt-3 create-next-btn" title={"Next"}
                          onClick={ () => {
                              history.push("/create/recipe/2")
                          }}/>}
    </>
    )
};