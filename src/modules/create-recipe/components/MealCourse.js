...
export const MealCourse = ({mealCoursesOptions, mealCourse, setMealCourse}) => {
        ...
        <>
            <div className="create-recipe-wrapper step2">
                ...
                <div className="input flex-column">
                    <b>Meal Course</b>
                    <CustomSelect value={mealCourse} onSelect={(e) => {
                        setMealCourse(e.target.value)
                    }}>
                        {
                            mealCoursesOptions.map(o => <option>{o}</option>)
                        }
                    </CustomSelect>
                </div>
            ...
            {mealCourse !== "" && <CustomButton className="mt-3 create-next-btn" title={"Next"}
                                              onClick={() => {
                                                  history.push("/create/recipe/3")
                                              }}/>}
        </>
    )
};